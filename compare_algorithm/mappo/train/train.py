...
# debug mode
parent_dir = '/data/dh4_gao/test/pytorch-maddpg/compare_algorithm/mappo'
...
from envs.MEC_env import mec_env
...
def make_train_env(all_args):
    ...
    return mec_env(all_args.agent_num, all_args.obs_dim, all_args.action_dim, task_rate = 2) 
