...
def get_config():
    ...
    parser.add_argument("--seed", type=int, default=1234, help="Random seed for numpy/torch")
    parser.add_argument(
        "--cuda",
        action="store_false",
        default=True,
    ...
    # env parameters
    parser.add_argument("--env_name", type=str, default="MEC_env", help="specify the name of environment")
    parser.add_argument(
        "--use_obs_instead_of_state",
        action="store_true",
        default=False,
    ...
    #agent parameters
    parser.add_argument("--agent_num", type=int, default=10, help="num of agents")
    parser.add_argument("--action_dim", type=int, default=10, help="action dim for agent")
    parser.add_argument("--obs_dim", type=int, default=3, help="observation dim for agent")
    

    # replay buffer parameters
    parser.add_argument("--episode_num", type=int, default=1000, help="Num of episodes to train")
    ...
    # optimizer parameters
    parser.add_argument("--lr", type=float, default=1e-6, help="learning rate (default: 5e-4)")
    parser.add_argument(
        "--critic_lr",
        type=float,
        default=5e-7,
