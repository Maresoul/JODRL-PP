...
class Runner(object):
    def __init__(self, config):
        ...
        self.episode_num = self.all_args.episode_num
        ...
        for agent_id in range(self.num_agents):
            share_observation_space = (
                (self.env.n_agents)*(self.env.n_obs)            #agent_num*obs_dim
        ...
        for agent_id in range(self.num_agents):
            ...
            # buffer
            share_observation_space = (
                (self.env.n_agents)*(self.env.n_obs)
                if self.use_centralized_V
                else self.envs.observation_space[agent_id]
            )
    ...
    def train(self):
        ...
        print(train_info['policy_loss'],train_info['value_loss'])
        return train_infos
